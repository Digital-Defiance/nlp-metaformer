...
pub fn scaled_dotproduct_selfattention_module(
    vs_path: &nn::Path,
    number_of_heads: i64,
    ...
    nn::func(move |x_bcd: &tch::Tensor| {
        ...
        let queries_bncq = &x_b1cd.matmul(&query_weights_1ndq);
        let keys_bncq = &x_b1cd.matmul(&key_weights_1ndq);
        let values_bncq = &x_b1cd.matmul(&value_weights_1ndq);
        ...
        let scaled_scores_bncc = &scores_bncc.divide_scalar(sqrt_q);
